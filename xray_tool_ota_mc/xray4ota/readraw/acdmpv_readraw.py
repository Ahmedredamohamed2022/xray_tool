...
################################################################ count no rawfiles######################
str0="/ciic/designs/analog-mixed-signal-blocks/Xschem-schematic/ota-2stage/xray4ota/ac/dmpv/rawfiles/"
dir_path = str0
count = 0
# Iterate directory
...
plt.text(USLAV, max(n)/2, 'USLtr', ha='center', va='center',fontweight ="bold")
plt.text(LSLAV, max(n)/2, 'LSLtr', ha='center', va='center',fontweight ="bold")
...
plt.savefig('/ciic/designs/analog-mixed-signal-blocks/Xschem-schematic/ota-2stage/xray4ota/ac/dmpv/figures/av.png', dpi=300, bbox_inches='tight')

Summary = open('/ciic/designs/analog-mixed-signal-blocks/Xschem-schematic/ota-2stage/xray4ota/ac/dmpv/00000/mcav.txt','w')
...
plt.legend()  
#plt.title("run= %d "% run + ", \u03BC = " +str(mean)+ ", \u03C3= " +str(std),fontweight ="bold")
plt.xlabel("Gain band with product",fontweight ="bold")
plt.ylabel("#Sample",fontweight ="bold")
##################################################### add a 'best fit' line
#xmin=float(mean)-6*float(std)
#xmax=float(mean)+6*float(std)
...
plt.text(USLGBW, max(n)/2, 'USLtr', ha='center', va='center',fontweight ="bold")
plt.text(LSLGBW, max(n)/2, 'LSLtr', ha='center', va='center',fontweight ="bold")
...
cpk="{:.2f}".format(cpk)
plt.title("run= %d "% run + ", \u03BC = " +str(mean)+ ", \u03C3= " +str(std)+"\n Cp= "+str(cp)+" ,cpk= "+str(cpk),fontweight ="bold")
plt.savefig('/ciic/designs/analog-mixed-signal-blocks/Xschem-schematic/ota-2stage/xray4ota/ac/dmpv/figures/gbw.png', dpi=300, bbox_inches='tight')

Summary = open('/ciic/designs/analog-mixed-signal-blocks/Xschem-schematic/ota-2stage/xray4ota/ac/dmpv/00000/mcgbw.txt','w')
Summary.write(str(read_file_no))
Summary.write("\n")
Summary.write(mean)
Summary.write("\n")
...
plt.text(USLPM, max(n)/2, 'USLtr', ha='center', va='center',fontweight ="bold")
plt.text(LSLPM, max(n)/2, 'LSLtr', ha='center', va='center',fontweight ="bold")
...
cpk="{:.2f}".format(cpk)
plt.title("run= %d "% run + ", \u03BC = " +str(mean)+ ", \u03C3= " +str(std)+"\n Cp= "+str(cp)+" ,cpk= "+str(cpk),fontweight ="bold")
plt.savefig('/ciic/designs/analog-mixed-signal-blocks/Xschem-schematic/ota-2stage/xray4ota/ac/dmpv/figures/pm.png', dpi=300, bbox_inches='tight')

Summary = open('/ciic/designs/analog-mixed-signal-blocks/Xschem-schematic/ota-2stage/xray4ota/ac/dmpv/00000/mcpm.txt','w')
Summary.write(str(read_file_no))
Summary.write("\n")
Summary.write(mean)
Summary.write("\n")
